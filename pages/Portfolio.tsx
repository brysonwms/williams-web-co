        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-lg text-zinc-600">
              A showcase of clean, effective websites we've built for businesses
              like yours. Every site is unique, responsive, and ready for growth.
            </p>
          </div>
          ...
          <div className="mt-32 p-12 md:p-20 bg-zinc-50 rounded-[3rem] border border-zinc-100 text-center">
            ...
            <p className="text-zinc-600 mb-10 max-w-xl mx-auto">
              We typically complete custom small business websites in 2–4 weeks.
