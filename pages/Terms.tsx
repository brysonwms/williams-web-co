...
const Terms = () => {
  useEffect(() => {
    document.title = "Terms of Service | Williams Web Co";
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Review the Terms of Service for Williams Web Co, including payment terms, services, and client responsibilities."
      );
    } else {
  ...
  return (
    <div className="pt-40 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-8 text-zinc-600 text-sm leading-relaxed">
        <p>
          This Agreement is entered into between Bryson Williams
          (“Service Provider”) and the purchasing client (“Client”).
        </p>

        <p>
          By submitting payment, the Client agrees to the terms below.
        </p>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>A one-time website setup fee is due in full before work begins</li>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>A recurring monthly fee is charged automatically via Stripe</li>
            <li>
        ...
        <section>
          ...
          <p className="mt-4">
            ...
            client’s behalf, ownership will be transferred to the client
            upon request or upon termination of services. If a domain is not
            purchased on the client’s behalf, clients are responsible for
            purchasing and maintaining ownership of their domain name. We
            assist with domain selection, setup, and DNS configuration as
            part of our service. If a client already owns a domain, access
            will be required in order to properly connect and configure the
            website.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <li>Upon cancellation, hosting and management services will end</li>
            <li>
        ...
        <section>
          ...
          <p>
            ...
            understood, and agreed to this Agreement, including the required
